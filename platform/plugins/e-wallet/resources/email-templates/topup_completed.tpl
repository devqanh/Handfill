    ...
    <table class="bb-box" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="bb-content bb-pb-0" align="center">
                ...
                <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/e-wallet::email-templates.topup_completed_title' | trans }}</h1>
            </td>
        </tr>
        <tr>
            <td class="bb-content">
                <p>{{ 'plugins/e-wallet::email-templates.topup_completed_greeting' | trans({'customer_name': customer_name}) }}</p>
                <p>{{ 'plugins/e-wallet::email-templates.topup_completed_message' | trans({'topup_amount': topup_amount}) }}</p>
            </td>
        </tr>
        <tr>
            ...
            <td class="bb-content bb-border-top">
                <table class="bb-row" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                            <td class="bb-col">
                                <h4 class="bb-m-0">{{ 'plugins/e-wallet::email-templates.current_balance' | trans }}</h4>
