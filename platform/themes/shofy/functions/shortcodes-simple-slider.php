        ...
        $form
            ->addBefore(
                ...
                UiSelectorFieldOption::make()
                    ...
                    ->helperText(__('"Full width" style only displays the slider image without any text or button - use an image around 1920x512 px for this style. The other styles (1-5) overlay text and a button on top of a taller hero area - use an image around 1920x950 px for those.'))
            )
            ->add(
