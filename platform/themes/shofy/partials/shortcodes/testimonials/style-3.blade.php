                ...
                <div class="tp-testimonial-slider-wrapper-5">
                    ...
                    <div class="tp-testimonial-slider-5 p-relative">
                        ...
                        <div class="tp-testimonial-arrow-5">
                            <button type="button" class="tp-testimonial-slider-5-button-prev" aria-label="{{ __('Previous') }}">
                            ...
                            <button type="button" class="tp-testimonial-slider-5-button-next" aria-label="{{ __('Next') }}">
                                <svg width="33" height="16" viewBox="0 0 33 16" fill="none" xmlns="http://www.w3.org/2000/svg">
