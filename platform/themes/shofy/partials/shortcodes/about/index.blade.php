                    ...
                    <div class="tp-about-thumb-wrapper p-relative mr-35">
                        @if($shortcode->image_1)
                            <div class="tp-about-thumb m-img">
                                {!! RvMedia::image($shortcode->image_1, \Theme\Shofy\Helpers\MediaAltResolver::resolve($shortcode->image_1, $shortcode->title)) !!}
                            </div>
                        @endif
                        @if($shortcode->image_2)
                            <div class="tp-about-thumb-2">
                                {!! RvMedia::image($shortcode->image_2, \Theme\Shofy\Helpers\MediaAltResolver::resolve($shortcode->image_2, $shortcode->title)) !!}
                            </div>
                        @endif
                    </div>
                @endif
